...
BOT_TOKEN = '8502910736:AAEP7FzHxnnIsuYsK6HOlcX317LZvzMKZTM'
...
async def get_user_profile_response(event, user, user_data):
    ...
    buttons = [
        ...
        [
            ...
            Button.inline("⭐ Оценить", f"rate_user_{user_id}")
        ]
    ]
...
"""
    ...
    buttons = [
        [Button.url("📢 Перейти в предложку", "https://t.me/Infinityantiscam")]
    ]
    ...
    try:
        ...
        if msg:
            ...
            await event.respond(
                "✅ Инструкция отправлена в ваши личные сообщения!",
                link_preview=False
            )
        ...
        await event.answer("❌ Не удалось отправить в ЛС. Смотрите ниже.", alert=True)
...
"""
        ...
        # Отправляем инструкцию в текущий чат
        await event.respond(
            error_text,
            buttons=buttons,
            parse_mode='md',
